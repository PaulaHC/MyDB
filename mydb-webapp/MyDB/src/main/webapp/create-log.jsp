<%-- 
    Document   : create-log
    Created on : 25 apr 2022, 16:56:21
    Author     : daniele
--%>

<%@page import="java.io.File"%>
<%@page import="java.util.ArrayList"%>
<%@page import="Modelo.Fich"%>
        ...
        <div class="container">
          ...
          <div class="collapsed navbar-collapse collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <!-- Already logged-in user, so "Register" and "Login" are useless -->
              <% String nombre = (String) request.getSession().getAttribute("user"); 
              if(nombre.equals("admin@admin.com")){
              %>
                <li class="nav-item" id="nav-item-tr">
        ...
        <div class="page-banner">
          <div class="row justify-content-center align-items-center h-100">
            <div class="col-md-6">
              ...
              <h1 class="text-center">Have fun creating or editing your own table!</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-12 py-3">
            <h2 class="title-section">MyDB, edit your table.</h2>
            ...
            <div class="row align-items-start">
              <div class="col-lg-8">
                ...
                >
                  ...
                  >
                    <button type="button" class="btn btn-primary" onclick="Fill_table()">Add</button>
                  </div>
                  <div
                    class="btn-group mr-2"
                    role="group"
                  ...
                  <div
                    ...
                    aria-label="First group"
                  >
                      <button type="button" class="btn btn-primary" id="saveInDBa" onclick="SaveInDB()">Save</button>
                ...
                <div class="col-lg-4">
                    <!--<form method="post" action="SaveDBSevlet">-->
                    <!-- Buttons above the table -->
                    <div
                      class="btn-toolbar mb-2"
                      role="toolbar"
                    ...
                    >
                      ...
                      <div
                        ...
                        aria-label="Second group"
                      >
                        <button id="exportFile" type="button" class="btn btn-primary" onclick="Export()">Export</button>
                      </div>
                    </div>
                    <!-- END buttons above the table -->
                    ...
                    >
                      <div
                        ...
                        aria-label="First group"
                      >
                          <!-- Search form for user files, and empty condition this does not have-->
                          <form action="LoadDBServlet" method="post" >
                              
                              <%ArrayList<File>  files= (ArrayList<File> )request.getAttribute("files");
                              String acceso=(String) request.getAttribute("acceso");
                              
                              if(files==null&& acceso==null){%>
                                    <button type="submit" class="btn btn-primary" id="loadF">Load existing data base</button>
                                    <script>emptyFile(false);</script>
                               <%}
                               if(files==null&& acceso=="true"){%>
                                    <script>emptyFile(true);</script>
                               <%}%>
                               
                          </form>
                      </div>
                    <!-- Choosing the file and calling the load function on the page -->
                    </div>
                          
                         <form action="DownloadDBServlet" method="post" >      
                          <% if(files!=null){%>
                                <label id="label_choose" >Choose your data base:</label>

                               <select name="selectDatabase" id="select">
                               ...
                               <button type="submit" class="btn btn-primary" id="download">Find</button>

                          <%}%>
                         </form>
                          <% String text=(String)request.getAttribute("chosenfile");%>
                           <script>translateToTable(<%= text%>);</script>
                    <!-- END buttons below the table -->
                </div>
