<%-- 
    Document   : create-log-admin
    Created on : 25 apr 2022, 16:56:03
    Author     : daniele
--%>
          ...
          <div class="collapsed navbar-collapse collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active" id="nav-item-tr">
                  <a class="nav-link" href="create-log-admin.jsp" onclick="/AdminServlet">Manage table</a>
              </li>
              <li class="nav-item" id="nav-item-tr">
              ...
              <div class="col-lg-4">
                ...
                >
                  <div
                    ...
                    aria-label="First group"
                  >
                    <button type="button" class="btn btn-primary">Load existing table</button>
                  </div>
                </div>
                <!-- END buttons below the table -->
              </div>
