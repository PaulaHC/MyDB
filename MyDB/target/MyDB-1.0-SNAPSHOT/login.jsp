  ...
  <body>
          ...
          <div class="row justify-content-center align-items-center h-100">
            <div class="col-md-6">
              ...
              <% String texto = (String)request.getAttribute("showText"); 
                  if(texto!=null){%>
                        <br><h2 class="text-center"><%= texto%></h2>
                  <%}else{%>
                        <p></p>
                  <%}%>
            </div>
    ...
    <div class="page-section">
      <div class="container">
          ...
          if("new".equals(show)){%>
                <script>showText("YOU HAS BEEN REGISTERED SUCCESFULLY!");</script>
          <%}%>
            ...
            <form method="post" action="LoginServlet">
              ...
              <div class="form-group row text-center">
                ...
                <div class="col-sm-8">
                  ...
                  />
                    <span id="forgotPasword" class="row text-center" name="PasswordText">
                        <p>click <a href="./recoverPassword.jsp">here</a> if you forget your password.</p>
                    </span>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-12 text-center">
                   <input type="submit" class="btn btn-primary" value="login" name="loger">
                </div>
              </div>
